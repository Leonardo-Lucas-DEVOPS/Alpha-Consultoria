...
class AuthenticatedSessionController extends Controller
{
    ...
    {
        // Verifica se o usuário está autenticado e se o e-mail foi verificado e se a verificação de e-mail foi feita há menos de 5 minutos
        if (Auth::check() && Auth::user()->email_verified_at && Auth::user()->email_verified_at->diffInMinutes(now()) < 5) {
